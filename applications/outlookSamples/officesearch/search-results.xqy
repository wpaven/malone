                              ...
                              <ul>
                               <li>
                                  <form id="{fn:concat("buttons",$res)}">
                                    ...
                                    <input type="radio" name="{$orig-uri}" value="embeddocument" id="searchtype" />Attach Document
	                          ...
	                          <a name="{$name}" class="test" href="{$anchor}" onclick="actionDocument('{$res}','{fn:data($s)}')">
                               ...
                               <li>
                                  <form id="{fn:concat("buttons",$res)}">
                                    ...
                                    <input type="radio" name="{$uri}" value="embeddocument" id="searchtype"/>Attach Document
